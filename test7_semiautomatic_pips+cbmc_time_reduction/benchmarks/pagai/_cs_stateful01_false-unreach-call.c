 ...
 *
 *  params:
 *    -i svcomp2015_unsafe/pthread/stateful01_false-unreach-call.c, --time 750, --unwind 2, --rounds 2, 
 *
 *  modules:
...
#define NULL 0
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[] = {5, 6, 6};
...
IF(0,0,tmain_1)
                                        ...
                                        __cs_mutex_init(&ma, 0);
                                        __cs_mutex_init(&mb, 0);
                                        data1 = 10;
                                        data2 = 10;
...
tmain_4: IF(0,4,tmain_5)
                                        __cs_local_main___cs_tmp_if_cond_0 = (data1 == 16) && (data2 == 5);
