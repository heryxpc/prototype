...
int main()
{
  ...
  main$tmp_guard1 = !(__unbuffered_p0_EAX == 1 && __unbuffered_p[0;1;35m[0m0_EBX == 0 && __unbuffered_p1_EAX == 1 && __unbuffered_p1_EBX == 0 && __unbuffered_p2_EAX == 1 && __unbuffered_p2_EBX == 0);
  __VERIFIER_atomic_end();
  /* Program proven to be relaxed for X86, model checker says YES. */
