[0;1;35m[0m[0;1;35m[0m[0;1;35m[0m[0;1;35m[0m[0;1;35m[0m[0;1;35m[0m[0;1;35m[0m[0;1;35m[0m[0;1;35m[0m[0;1;35m[0m[0;1;35m[0m[0;1;35m[0mvoid __VERIFIER_assert(int x) { if(!(x)) {ERROR: /* reachable */
                                                 /* reachable */
                                                 /* reachable */
                                                 /* reachable */
                                                 /* reachable */
 ...
 *
 *  params:
 *    -i /home/heryxpc/Documents/soton/dissertation/prototype/test7/benchmarks/fib_bench_longest_false-unreach-call.c, --rounds 11, --unwind 11, -l out, --backend cpachecker, 
 *
 *  modules:
...
int __cs_mutex_destroy(__cs_mutex_t *__cs_mutex_to_destroy)
{
       ...
       [0;1;35m[0m[0;1;35m[0m[0;1;35m[0m return 0;
}
...
void *t2_0(void *__cs_param_t2_arg)
{
        ...
        __cs_local_t2_k++;
        {
    [0;1;35m[0m[0;1;35m[0m            tt2_0_4: IF(2,4,tt2_0_5)
                j += i;
        }
        ;
        __cs_local_t2_k++;
...
if (__cs_active_thread[1] == 1)
{
        ...
        __VERIFIER_assume(__cs_pc_cs[1] >= __cs_pc[1]);
        __VERIFIER_assume(__cs_pc_cs[[0;1;35m[0m1] <= 13);
        t1_0(__cs_threadargs[__cs_thread_index]);
        __cs_pc[1] = __cs_pc_cs[1];
}
if (__cs_active_thread[2] == 1)
