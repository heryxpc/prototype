 ...
 *
 *  params:
 *    --unwind 11, --rounds 10, -l out, --backend cpachecker, -i /home/heryxpc/Documents/soton/dissertation/prototype/test7/benchmarks/cbmc/fib_bench_longest_false-unreach-call_anno.c, 
 *
 *  modules:
...
#define NULL 0
 ...
 unsigned int __cs_thread_lines[] = {3, 24, 24};
...
void *t1_0(void *__cs_param_t1_arg)
{
        ...
        __cs_local_t1_k = 0;
        {
                ...
                __VERIFIER_assume(((11 - __cs_local_t1_k) >= 0) && (__cs_local_t1_k >= 0));
        ...
        __exit_loop_1:
        __VERIFIER_assume(__cs_pc_cs[1] >= 24);
        ;
        ;
        goto __exit_t1;
        ;
