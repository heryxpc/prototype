 ...
 *
 *  params:
 *    -i svcomp2015_unsafe/pthread-ext/40_barrier_vf_false-unreach-call.c, --time 750, --unwind 4, --rounds 4, 
 *
 *  modules:
...
#define NULL 0
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[] = {5, 8, 8, 8, 8};
                                        ...
                                        *__cs_cond_to_signal = 1;
                                        ...
                                        {
                                        __CPROVER_assume(MTX == 0);
                                        MTX = 1;
                                        }
                                        void __CSEQ_atomic_release()
                                        {
                                        __CPROVER_assume(MTX == 1);
                                        MTX = 0;
                                        }
...
tthr1_0_1: IF(1,1,tthr1_0_2)
                                        count++;
                                        static _Bool __cs_local_Barrier2___cs_tmp_if_cond_0;
                                        __cs_init_scalar(&__cs_local_Barrier2___cs_tmp_if_cond_0, sizeof(_Bool));
tthr1_0_2: IF(1,2,tthr1_0_3)
                                        __cs_local_Barrier2___cs_tmp_if_cond_0 = count == 3;
                                        if (__cs_local_Barrier2___cs_tmp_if_cond_0)
                                        				{
                                        __cs_thread_local_COND[__cs_thread_index] = 1;
...
tthr1_0_5: IF(1,5,tthr1_0_6)
                                        __CPROVER_assume(__cs_thread_local_COND[__cs_thread_index]);
                                        __cs_thread_local_COND[__cs_thread_index] = 0;
...
IF(3,0,tthr1_2_1)
                                        __CSEQ_atomic_acquire();
tthr1_2_1: IF(3,1,tthr1_2_2)
                                        count++;
                                        static _Bool __cs_local_Barrier2___cs_tmp_if_cond_0;
                                        __cs_init_scalar(&__cs_local_Barrier2___cs_tmp_if_cond_0, sizeof(_Bool));
tthr1_2_2: IF(3,2,tthr1_2_3)
                                        __cs_local_Barrier2___cs_tmp_if_cond_0 = count == 3;
                                        if (__cs_local_Barrier2___cs_tmp_if_cond_0)
                                        				{
                                        __cs_thread_local_COND[__cs_thread_index] = 1;
tthr1_2_3: IF(3,3,tthr1_2_4)
                                        count = 0;
                                        				}
                                        				else
                                        				{
                                        __CPROVER_assume(__cs_pc_cs[3] >= 4);
tthr1_2_4: IF(3,4,tthr1_2_5)
                                        __CSEQ_atomic_release();
tthr1_2_5: IF(3,5,tthr1_2_6)
                                        __CPROVER_assume(__cs_thread_local_COND[__cs_thread_index]);
                                        __cs_thread_local_COND[__cs_thread_index] = 0;
tthr1_2_6: IF(3,6,tthr1_2_7)
                                        __CSEQ_atomic_acquire();
                                        				}
...
IF(4,0,tthr1_3_1)
                                        __CSEQ_atomic_acquire();
tthr1_3_1: IF(4,1,tthr1_3_2)
                                        count++;
                                        static _Bool __cs_local_Barrier2___cs_tmp_if_cond_0;
                                        __cs_init_scalar(&__cs_local_Barrier2___cs_tmp_if_cond_0, sizeof(_Bool));
tthr1_3_2: IF(4,2,tthr1_3_3)
                                        __cs_local_Barrier2___cs_tmp_if_cond_0 = count == 3;
                                        if (__cs_local_Barrier2___cs_tmp_if_cond_0)
                                        				{
                                        __cs_thread_local_COND[__cs_thread_index] = 1;
tthr1_3_3: IF(4,3,tthr1_3_4)
                                        count = 0;
                                        				}
                                        				else
                                        				{
                                        __CPROVER_assume(__cs_pc_cs[4] >= 4);
tthr1_3_4: IF(4,4,tthr1_3_5)
                                        __CSEQ_atomic_release();
tthr1_3_5: IF(4,5,tthr1_3_6)
                                        __CPROVER_assume(__cs_thread_local_COND[__cs_thread_index]);
                                        __cs_thread_local_COND[__cs_thread_index] = 0;
tthr1_3_6: IF(4,6,tthr1_3_7)
                                        __CSEQ_atomic_acquire();
                                        				}
...
tmain_2: IF(0,2,tmain_3)
                                        __cs_create(&__cs_local_main_t, 0, thr1_2, 0, 3);
                                        		}
                                        		;
                                        		{
tmain_3: IF(0,3,tmain_4)
                                        __cs_create(&__cs_local_main_t, 0, thr1_3, 0, 4);
                                        		}
                                        		;
...
tmain_5: 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_tmp_t3_r2 = (unsigned __CPROVER_bitvector[4])nondet_uint();
                                        unsigned __CPROVER_bitvector[4] __cs_tmp_t4_r2 = (unsigned __CPROVER_bitvector[4])nondet_uint();
                                        unsigned __CPROVER_bitvector[3] __cs_tmp_t0_r3 = (unsigned __CPROVER_bitvector[3])nondet_uint();
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_tmp_t3_r3 = (unsigned __CPROVER_bitvector[4])nondet_uint();
                                        unsigned __CPROVER_bitvector[4] __cs_tmp_t4_r3 = (unsigned __CPROVER_bitvector[4])nondet_uint();
                                        unsigned __CPROVER_bitvector[3] __cs_tmp_t0_r4 = (unsigned __CPROVER_bitvector[3])nondet_uint();
/* round  0 */
...
/* round  1 */
                                        ...
                                        __CPROVER_assume(__cs_pc_cs[3] <= 8);
                                        thr1_2(__cs_threadargs[__cs_thread_index]);
                                        __cs_pc[3] = __cs_pc_cs[3];
                                        		}
                                        if (__cs_active_thread[4] == 1)
                                        		{
                                        ...
                                        __CPROVER_assume(__cs_pc_cs[4] <= 8);
                                        thr1_3(__cs_threadargs[__cs_thread_index]);
                                        __cs_pc[4] = __cs_pc_cs[4];
                                        		}
/* round  2 */
                                        if (__cs_active_thread[0] == 1)
