 ...
 *
 *  params:
 *    -i svcomp2015_unsafe/pthread-wmm/safe027_power.oepc_false-unreach-call.c, --time 750, --rounds 2, 
 *
 *  modules:
...
#define NULL 0
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[] = {18, 23, 5, 20, 10};
