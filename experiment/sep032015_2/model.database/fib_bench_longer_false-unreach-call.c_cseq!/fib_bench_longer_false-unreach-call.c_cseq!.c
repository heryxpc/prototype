# 1 "./fib_bench_longer_false-unreach-call.c_cseq.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "<command-line>" 2
# 1 "./fib_bench_longer_false-unreach-call.c_cseq.c"
extern void __VERIFIER_assert(int x);
 ...
 *
 *  params:
 *    -i fib_bench_longer_false-unreach-call.c, -l out, --backend cpachecker, --rounds 7, --unwind 7, 
 *
 *  modules:
...
# 38 "./fib_bench_longer_false-unreach-call.c_cseq.c" 2
...
# 39 "./fib_bench_longer_false-unreach-call.c_cseq.c" 2
# 47 "./fib_bench_longer_false-unreach-call.c_cseq.c"
 unsigned int __cs_active_thread[2 + 1] = {1};
 unsigned int __cs_pc[2 + 1];
 unsigned int __cs_pc_cs[2 + 1];
 unsigned int __cs_thread_index;
 unsigned int __cs_thread_lines[] = {3, 8, 8};
 
extern void *__cs_safe_malloc(int __cs_size);
extern void __cs_init_scalar(void *__cs_var, int __cs_size);
extern void __CSEQ_message(char *__cs_message);
typedef int __cs_t;
void *__cs_threadargs[2 + 1];
extern int __cs_create(__cs_t *__cs_new_thread_id, void *__cs_attr, void *(*__cs_t)(void *), void *__cs_arg, int __cs_threadID);
extern int __cs_join(__cs_t __cs_id, void **__cs_value_ptr);
extern int __cs_exit(void *__cs_value_ptr);
typedef int __cs_mutex_t;
extern int __cs_mutex_init(__cs_mutex_t *__cs_m, int __cs_val);
extern int __cs_mutex_destroy(__cs_mutex_t *__cs_mutex_to_destroy);
extern int __cs_mutex_lock(__cs_mutex_t *__cs_mutex_to_lock);
extern int __cs_mutex_unlock(__cs_mutex_t *__cs_mutex_to_unlock);
typedef int __cs_cond_t;
extern int __cs_cond_init(__cs_cond_t *__cs_cond_to_init, void *__cs_attr);
extern int __cs_cond_wait_1(__cs_cond_t *__cs_cond_to_wait_for, __cs_mutex_t *__cs_m);
extern int __cs_cond_wait_2(__cs_cond_t *__cs_cond_to_wait_for, __cs_mutex_t *__cs_m);
extern int __cs_cond_signal(__cs_cond_t *__cs_cond_to_signal);
extern void __VERIFIER_error();
int i = 1;
int j = 1;
extern void *t1_0(void *__cs_param_t1_arg);
extern void *t2_0(void *__cs_param_t2_arg);
