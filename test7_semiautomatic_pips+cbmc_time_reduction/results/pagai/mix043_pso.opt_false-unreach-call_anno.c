...
int main()
{
  ...
  /* Program proven to be relaxed for X86, model checker says YES. */
  z$r_buff0_thd0 = weak$$choice2 ? z$r_buff0_thd0 : (!z$w_buff0_used || !z$r_buff0_thd0 && !z$w_buff1_used || !z$r_buff0_thd0 && !z$r_buff1_thd0 ? z$r_buff0_thd0 : (z$w_buff0_used && z$r_buff0_thd0 ? FALSE : z$r[0;1;35m[0m_buff0_thd0));
  /* Program proven to be relaxed for X86, model checker says YES. */
