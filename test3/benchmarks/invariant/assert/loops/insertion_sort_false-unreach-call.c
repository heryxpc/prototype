...
int main() {
   ...
   __VERIFIER_assert(2147483647-j >= 0 && -1+j >= 0);
   for (/* invariant:
        2147483647-j >= 0
        -1+j >= 0
        */
      ...
      __VERIFIER_assert(2147483646-i >= 0 && -1-i+j >= 0 && -1+j >= 0 && -1+SIZE-j >= 0 && 1+i >= 0);
      /* invariant:
      2147483646-i >= 0
      -1-i+j >= 0
      -1+j >= 0
  ...
  __VERIFIER_assert(2147483647-SIZE >= 0 && 2147483647-k >= 0 && -1+k >= 0);
  for (/* invariant:
       2147483647-SIZE >= 0
       2147483647-k >= 0
       -1+k >= 0
