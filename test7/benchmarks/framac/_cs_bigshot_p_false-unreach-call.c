 ...
 *
 *  params:
 *    -i svcomp2015_unsafe/pthread/bigshot_p_false-unreach-call.c, --time 750, --rounds 2, --unwind 1, 
 *
 *  modules:
...
#define NULL 0
                                        ...
                                        *__cs_cond_to_signal = 1;
                                        ...
                                        {
IF(1,0,tthread1_0_1)
                                        v = __cs_safe_malloc((sizeof(char)) * 8);
                                        __exit_thread1:
...
IF(2,0,tthread2_0_1)
                                        __cs_init_scalar(&__cs_local_thread2___cs_tmp_if_cond_1, sizeof(_Bool));
