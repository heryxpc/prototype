 ...
 *
 *  params:
 *    -i svcomp2015_unsafe/pthread-wmm/mix040_power.oepc_false-unreach-call.c, --time 750, --rounds 2, 
 *
 *  modules:
...
#define NULL 0
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[] = {16, 22, 12, 12, 29};
...
tP0_0_5: IF(1,5,tP0_0_6)
                                        assert(!(b$w_buff1_used && b$w_buff0_used));
