 ...
 *
 *  params:
 *    -i svcomp2015_unsafe/pthread-wmm/mix001_power.oepc_false-unreach-call.c, --time 750, --rounds 2, 
 *
 *  modules:
...
#define NULL 0
                                        ...
                                        unsigned __CPROVER_bitvector[6] __cs_thread_lines[] = {15, 36, 14, 27};
