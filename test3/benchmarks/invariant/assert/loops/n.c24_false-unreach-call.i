...
int main(){
   ...
   for (/* invariant:
      ...
      if (tmp_cnt < 0)
         return -1;
      assert(2147483647-offset >= 0 && offset >= 0 && tmp_cnt-offset >= 0 && i >= 0);
      for ( /* invariant:
            2147483647-offset >= 0
            offset >= 0
            tmp_cnt-offset >= 0
                                          ...
                                          offset++ )
      {
         ...
         if ( ( ret == 0 ) || ( ret == 1 ) )
          ...
          assert(2147483647-j >= 0 && 2147483647-offset >= 0 && offset >= 0 && -1+tmp_cnt-offset >= 0 && j >= 0 && i >= 0);
         for ( /* invariant:
               2147483647-j >= 0
               2147483647-offset >= 0
               offset >= 0
