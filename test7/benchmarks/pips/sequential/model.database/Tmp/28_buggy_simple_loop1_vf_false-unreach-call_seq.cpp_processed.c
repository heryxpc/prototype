...
unsigned int __VERIFIER_nondet_uint(void){unsigned int n; return n; }
_Bool __VERIFIER_nondet_bool(void){_Bool b; return b; }
char __VERIFIER_nondet_char(void){char c; return c; }
unsigned char __VERIFIER_nondet_uchar(void){unsigned char c; return c; }
/*
