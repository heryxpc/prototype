 ...
 *
 *  params:
 *    -i svcomp2015_unsafe/pthread-wmm/mix021_power.oepc_false-unreach-call.c, --time 750, --rounds 2, 
 *
 *  modules:
...
#define NULL 0
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[] = {16, 22, 12, 12, 27};
