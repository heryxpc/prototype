...
int main()
{
  ...
  /* Program proven to be relaxed for X86, model checker says YES. */
  y$w_buff1_used = weak$$choice2 ? y$w_buff1_used : (!y$w_buff0_used || !y$r_buff0_thd0 && !y$w_buff1_used || !y$r_buff0_thd0 && !y$r_buff1_thd0 ? y$w_buff1_used : (y$w_buff0_used && y$r_buff0_thd0 ?[0;1;35m[0m FALSE : FALSE));
  /* Program proven to be relaxed for X86, model checker says YES. */
