// analysis: AIopt
[0;1;34m/* processing Function ssl3_connect */
[0m[0;1;34m/* processing Function main */
[0mextern void __VERIFIER_error() __attribute__ ((__noreturn__));
                                                                  ...
                                                                  if (s->state == 4352) {
                                                                    ...
                                                                    if (s->state == 3) {
                                                                      ...
                                                                      if (0) {
                                                                        ...
                                                                        s->state = 4096;
                                                                        [0;1;31m// unsafe: possible undefined behavior
[0m                                                                        (s->ctx)->stats.sess_connect_renegotiate += 1;
                                                                        switch_1_16384: ;
                                                                        switch_1_4096: ;
                                                                        switch_1_20480: ;
                                                                        switch_1_4099:
...
[0m                                                                          (s->ctx)->stats.sess_hit += 1;
                                                                        ...
                                                                        [0;1;31m// unsafe: possible undefined behavior
[0m                                                                        (s->ctx)->stats.sess_connect_good += 1;
                                                                        if ((unsigned long )cb != (unsigned long )((void *)0)) {
